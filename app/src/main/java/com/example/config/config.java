...
import com.eureka.xllivetv.BuildConfig;

public class config {

    public static final String main = "https://eurekaxl.svc.re";
//    public static String mainurl = "http://www.battleworld.in/netklix/play/";
    public static final String mainurl = "https://eurekaxl.svc.re";

//    public static final String privacypolicy = "https://sites.google.com/view/primeflixapp/home";
    public static final String privacypolicy = "https://eureka-xl.flycricket.io/privacy.html";

    public static final String paytmchecksum = mainurl + "paytm/";

    public static final String appurl = "https://eurekaxl.svc.re/app.apk";
